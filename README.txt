...
Directed Automated Gating (DAG) is a filtering algorithm, which performs hierarchical gating to select the 
cell populations that are of interest and input them into a clustering algorithm such as FLOCK.
